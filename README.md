# 🚀 RexBots — Save Restricted Content Bot (Advanced)
...
| **Music** | Spotify, JioSaavn (with ID3/cover-art tagging via mutagen) |
...
```bash
docker build -t rexbots .
docker run -d --env-file .env rexbots
```
