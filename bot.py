...
class Bot(Client):
    ...
    async def start(self, **kwargs):
        ...
        try:
            from Rexbots.forward_engine import start_forwarding
            from database.db import db
            restored = 0
        ...
        try:
            from Rexbots.titanium import boot_personal_bots
    ...
    BotCommand("ftmmanager",    "🚀 FTM Manager control panel"),
    ...
    BotCommand("forward",       "➡️ Forward a message id range (alias of /fwd)"),
    ...
    BotCommand("addreplacer",   "🔄 Add forward word replacer"),
    BotCommand("clearreplacer", "🗑️ Clear forward word replacers"),
    BotCommand("addremover",    "➖ Add forward word remover"),
    BotCommand("clearremover",  "🗑️ Clear forward word removers"),
    BotCommand("setprefix",     "➕ Set forward filename prefix"),
    BotCommand("setsuffix",     "➕ Set forward filename suffix"),
    BotCommand("clearcaption",  "🗑️ Clear forward caption"),
    BotCommand("setbutton",     "🔘 Set forward inline button"),
    BotCommand("delbutton",     "🗑️ Delete forward inline button"),
    BotCommand("setfilters",    "🧰 Configure forward filters"),
    BotCommand("textonlymode",  "🔤 Toggle text-only forwarding"),
    BotCommand("pimode",        "🥧 Pi Mode info"),
    BotCommand("numbering",     "🔢 Toggle message numbering"),
    BotCommand("bullets",       "•️ Toggle bullet points"),
    BotCommand("usernameremover","🚫 Toggle username remover"),
    BotCommand("linkremover",   "🚫 Toggle link remover"),
    BotCommand("thetamode",     "🎭 Toggle Theta Mode"),
    BotCommand("blastmode",     "💥 Toggle Blast Mode"),
    BotCommand("coursesellers", "🎓 Toggle course sellers preset"),
    BotCommand("deltamode",     "🔺 Toggle Delta Mode"),
    ...
    BotCommand("dailymotion",   "🎬 Download from Dailymotion"),
