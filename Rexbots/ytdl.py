...
async def _show_quality_picker(client: Client, message: Message, url: str, fallback_candidates=None, minimal: bool = False):
    if yt_dlp is None:
    ...
    try:
        ...
        if info is None:
            ...
            if YOUTUBE_PATTERN.search(url):
                try:
                    from Rexbots.youtube import _handle_youtube_fallback
