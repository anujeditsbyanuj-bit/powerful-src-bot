# Rexbots
# Forward Engine — the actual "FTM Manager" core: monitors Source
# channels and copies every new message into Target channels, through
# the user's own connected bot (Rexbots/multibot.py -> /setbot).
#
...
logger = logging.getLogger("Rexbots.forward_engine")
...
async def pimode_command(client: Client, message: Message):
    ...
    target channels — Rexbots' /addtarget already supports unlimited
...
# ---------------------------------------------------------------------
# Extra FTM Manager toggles: Numbering, Bullets, Username/Link Remover,
