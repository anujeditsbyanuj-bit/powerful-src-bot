...
def get_settings_buttons():
    if BUTTON_STYLE_SUPPORTED:
        ...
        return InlineKeyboardMarkup([
            ...
            [make_button(" 🚀 ꜰᴛᴍ ᴍᴀɴᴀɢᴇʀ ", callback_data="ftmmanager_btn", icon_custom_emoji_id=ICON_LIST, style=S.PRIMARY)],
        ...
        return InlineKeyboardMarkup([
            ...
            [make_button(" 🗄 ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ ", callback_data="database_btn", icon_custom_emoji_id=ICON_INFO)],
            [make_button(" 📡 ᴄʜᴀɴɴᴇʟs ", callback_data="channels_btn", icon_custom_emoji_id=ICON_LIST)],
            [make_button(" 🚀 ꜰᴛᴍ ᴍᴀɴᴀɢᴇʀ ", callback_data="ftmmanager_btn", icon_custom_emoji_id=ICON_LIST)],
